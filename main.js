...
let numbtime = document.querySelector('#numbtime')
let apply = document.querySelector('#setbtn')
let settingcard = document.querySelector('#settingCard')

setting.addEventListener('click',()=>{
  settingcard.style.transform = 'translateY(0px)'
})
...
apply.addEventListener('click',()=>{
    timer = numbtime.value
    console.log(timer)
    timersec(timer)
    settingcard.style.transform = 'translateY(-500px)'
  })
